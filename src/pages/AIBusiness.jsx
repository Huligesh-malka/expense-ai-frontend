...
export default function AIBusiness() {
  ...
  // Step 1 analytics currently returns data, not AI-generated
  // opportunities/risks/strategy. These arrays are kept empty
  // until the Step 2 AI engine is connected.
